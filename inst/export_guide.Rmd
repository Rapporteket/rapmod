...
title: '`r paste0("Veiledning for eksport av ", params$registry_name, "-data")`'
---

```{r dbName, echo=FALSE}
dbName <- rapbase::getConfig()[[params$registry_name]]$name
```

## Eksport av `r params$registry_name`-databasen
